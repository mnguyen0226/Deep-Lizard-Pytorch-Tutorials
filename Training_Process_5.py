"""
    ...
    14/ Using Sequential model: allow us to build PyTorch nn without having to build explicit class, skip over forward() methods
    15/ batch Normalization: After normalize a dataset, we divide them into batch then normalize them again
...
# Step 14: Implement the same nn with sequential model, this encoded the forward function for us
# sequential = nn.Sequential(
#     nn.Conv2d(in_channels=1, out_channels=6, kernel_size=5) # Layer
#     , nn.ReLU()
#     , nn.MaxPool2d(kernel_size=2, stride=2)
#     , nn.Conv2d(in_channels=6, out_channels=12, kernel_size=5) # Layer
#     , nn.ReLU()
#     , nn.MaxPool2d(kernel_size=2, stride=2)
#     , nn.Flatten(start_dim=1)
#     , nn.Linear(in_features=12 * 4 * 4, out_features=120) # Layer
#     , nn.ReLU()
#     , nn.Linear(in_features=120, out_features=60) # Layer
#     , nn.ReLU()
#     , nn.Linear(in_features=60, out_features=10) # Layer
# )
